...
public interface BookRepository extends CrudRepository<Book, Long>
{
    ...
    @Query(value = "INSERT INTO wrote(bookid, authorid, created_by, created_date, last_modified_by, last_modified_date) VALUES (:bookid, :authorid, :uname, CURRENT_TIMESTAMP, :uname, CURRENT_TIMESTAMP)",
           nativeQuery = true)
    ...
    @Query(value = "SELECT COUNT(*) as count FROM wrote WHERE bookid = :bookId AND authorid = :authorId",
           nativeQuery = true)
    JustTheCount checkWrote(long bookId,
                            long authorId);
}
